...
BLOG_AUTHOR = "Sadanand Singh"  # (translatable)
BLOG_TITLE = "Sadanand's Notes"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://sadanand-singh.github.io/"
...
# is in the manual.
COMMENT_SYSTEM_ID = "sadanandsblog"
...
MARKDOWN_EXTENSIONS = ['toc', 'fenced_code', 'codehilite', 'extra', 'admonition', 'sane_lists', 'wikilinks']
